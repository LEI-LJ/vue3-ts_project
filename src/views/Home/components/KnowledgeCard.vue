...
defineProps<{ knowledge: Knowledge }>()
...
<template>
  <div class="knowledge-card van-hairline--bottom">
    ...
    <div class="body">
      ...
      <div class="imgs" :class="{ large: knowledge.coverUrl.length === 1 }">
        <van-image
          fit="cover"
      ...
      <p class="logs">
        <span>{{ knowledge.collectionNumber }} 收藏</span>
        <span>{{ knowledge.commentNumber }} 评论</span>
      </p>
    </div>
  </div>
</template>
